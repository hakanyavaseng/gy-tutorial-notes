...
Person person = new()
{
    ...
    Address = new()
    {
        PersonAddress = "Odunpazarı/ESKİŞEHİR"
    }
};
...
person.Address = new()
{
    PersonAddress = "Seyitgazi/ESKİŞEHİR"
};
await context.SaveChangesAsync();
*/
...
#region 1. Örnek, 1. Kitaba 3. Yazarı ekleme
...
#region 2. Örnek, 3. Yazarın 2. ve 3. Kitaplarını silme
/*
